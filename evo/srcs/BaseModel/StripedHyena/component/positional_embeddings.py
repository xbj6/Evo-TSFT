...
class LinearlyScaledRotaryEmbedding(RotaryEmbedding):
    ...
    def _update_cos_sin_cache(self, seqlen, device=None, dtype=None):
        ...
        if self.scale is None:
            ...
            self._extracted_from__update_cos_sin_cache_40(seqlen, freqs, dtype)

    # TODO Rename this here and in `_update_cos_sin_cache`
    def _extracted_from__update_cos_sin_cache_40(self, seqlen, freqs, dtype):
        power = (
